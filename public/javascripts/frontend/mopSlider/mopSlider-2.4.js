...
jQuery.fn.extend({
	mopSlider:function(setting){
		...
		if(mopSliderType=="paper"){
			...
			btnLeft.src="/images/frontend/mopSlider/sliderBtnLeft.png";
			btnLeftF.src="/images/frontend/mopSlider/sliderBtnLeft_f.png";
			btnRight.src="/images/frontend/mopSlider/sliderBtnRight.png";
			btnRightF.src="/images/frontend/mopSlider/sliderBtnRight_f.png";
			btnCenter.src="/images/frontend/mopSlider/sliderBtn.png";
			btnChange.src="/images/frontend/mopSlider/sliderBackRightRight.png";
			btnChangeF.src="/images/frontend/mopSlider/sliderBackRightRight_f.png";
			backImg.src="/images/frontend/mopSlider/monoBack.gif";
			sldcLeftImg.src="/images/frontend/mopSlider/sliderBackLeftLeft.png";
			sldcRightImg.src="/images/frontend/mopSlider/sliderBackRightRight.png";
			sldBackLeft.src="/images/frontend/mopSlider/sliderBackLeft.png";
			sldBackCenter.src="/images/frontend/mopSlider/sliderBack.png";
			sldBackRight.src="/images/frontend/mopSlider/sliderBackRight.png";
		}
		...
		/*set css*/
		$(mopSliderName+" .sliderCase").css({height:"29px",position:"relative",top:"0px"});
		$(mopSliderName+" .sliderCaseLeft").css({height:"29px",width:"25px",position:"absolute",top:"0px",left:"0px",backgroundImage:"url("+sldcLeftImg.src+")",backgroundRepeat:"no-repeat"});
		$(mopSliderName+" .sliderCaseRight").css({height:"29px",width:"25px",position:"absolute",top:"0px",right:"0px",backgroundImage:"url("+sldcRightImg.src+")",cursor:"",backgroundRepeat:"no-repeat",display:"none"});
		$(mopSliderName+" .slider").css({height:"29px",position:"relative",top:"0px",left:"25px"});
		$(mopSliderName+" .sldLeft").css({left:"0px",position:"absolute",height:"29px",width:"20px",backgroundImage:"url("+sldBackLeft.src+")",backgroundRepeat:"no-repeat"});
		$(mopSliderName+" .sldCenter").css({left:"20px",width:sldW-40+px,position:"absolute",height:"29px",backgroundImage:"url("+sldBackCenter.src+")",backgroundRepeat:"repeat-x"});
		$(mopSliderName+" .sldRight").css({right:"0px",position:"absolute",height:"29px",width:"25px",backgroundImage:"url("+sldBackRight.src+")",backgroundRepeat:"no-repeat"});
		$(mopSliderName+" .sliderBtn").css({position:"absolute",height:"29px",left:"0px",cursor:"default",top:"-5px"});
		$(mopSliderName+" .sldBtnLeft").css({left:"0px",position:"absolute",height:"29px",width:"20px",backgroundImage:"url("+btnLeft.src+")",backgroundRepeat:"no-repeat"});
		$(mopSliderName+" .sldBtnCenter").css({left:"20px",width:btnW-40+px,position:"absolute",height:"29px",backgroundImage:"url("+btnCenter.src+")",backgroundRepeat:"repeat-x"});
		$(mopSliderName+" .sldBtnRight").css({right:"0px",position:"absolute",height:"29px",width:"20px",backgroundImage:"url("+btnRight.src+")",backgroundRepeat:"no-repeat"});
		//$(mopSliderName+" .indi").css({paddingTop:"5px",fontSize: "0",textAlign:"center",fontFamily:"Arial, Helvetica, sans-serif",letterSpacing:"0.05em",color:"#2b313e"});
